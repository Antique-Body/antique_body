...
export const useAuthForm = ({ onSubmit, externalCodeError, externalCodeSent, externalSendingCode }) => {
    ...
    const getFieldClassName = (fieldName) => (errors[fieldName]?.message ? "border-red-500" : "");
