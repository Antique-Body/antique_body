...
export const leaveGlobalPresence = async (userId = null) => {
  try {
    ...
    if (!client || !client.connection) {
      console.warn(
        "Ably client or connection not available for leaving presence"
      );
      return false;
    }
    ...
    if (
      ...
      console.warn(
        "Ably connection is closed or failed, skipping presence leave"
      );
      return false;
    }
...
export const joinChatPresence = async (channelName, user) => {
  try {
    ...
    if (!client || !client.connection) {
      console.warn(
        "Ably client or connection not available for joining chat presence"
      );
      return false;
    }
    ...
    if (
      ...
      console.warn(
        "Ably connection is closed or failed, skipping chat presence join"
      );
      return false;
    }
...
export const updateTypingStatus = async (
  ...
  try {
    ...
    if (!client || !client.connection) {
      console.warn(
        "Ably client or connection not available for updating typing status"
      );
      return false;
    }
    ...
    if (
      ...
      console.warn(
        "Ably connection is closed or failed, skipping typing status update"
      );
      return false;
    }
    ...
    if (!channel || !channel.presence) {
      console.warn(
        "Chat presence channel not available for typing status update"
      );
      return false;
    }
