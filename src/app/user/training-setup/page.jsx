...
const TrainingSetup = () => {
    ...
    const areMeasurementsValid = useCallback(
        () => currentStep !== 9 || userSelections.measurements?.isValid === true,
    ...
    const renderLoadingState = () => (
        <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center">
            <div className="text-white text-center">
                <div className="mb-4">{isRedirecting ? t("training_setup.redirecting") : t("training_setup.saving")}</div>
    ...
    return (
        <div className="min-h-screen bg-[#0a0a0a] text-white relative">
            ...
            <div className="max-w-[550px] mx-auto px-5 py-5 relative z-20 min-h-screen flex flex-col items-center">
                ...
                <div className="mb-5">
                    <Card width="100%">
                        <div className="text-2xl sm:text-3xl font-bold mb-2">{t("training_setup.title")}</div>
                        <div className="text-[#aaa] text-base mb-4">{t("training_setup.description")}</div>
                        <div
                ...
                <div className="mt-4 flex w-full">
                    <ProgressBar value={currentStep} maxValue={TOTAL_STEPS} label={t("training_setup.step")} />
                </div>
            </div>
        </div>
    );
