...
const LoadingScreen = () => {
  ...
  const [loadingText, setLoadingText] = useState("Analiziramo vaš fitnes profil");
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white flex flex-col relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-[25%] left-[40%] w-1.5 h-1.5 bg-white rounded-full opacity-30 animate-twinkle" style={{ animationDelay: "0.7s" }}></div>
        <div className="absolute top-[15%] right-[30%] w-1 h-1 bg-white rounded-full opacity-40 animate-twinkle" style={{ animationDelay: "1.3s" }}></div>
        <div className="absolute top-[70%] left-[25%] w-1.5 h-1.5 bg-white rounded-full opacity-30 animate-twinkle" style={{ animationDelay: "0.9s" }}></div>
        <div className="absolute top-[60%] right-[20%] w-1 h-1 bg-white rounded-full opacity-40 animate-twinkle" style={{ animationDelay: "1.7s" }}></div>
        <div className="absolute top-[80%] right-[35%] w-1.5 h-1.5 bg-white rounded-full opacity-30 animate-twinkle" style={{ animationDelay: "2.1s" }}></div>
      </div>
      ...
      <div className="max-w-md mx-auto px-5 py-12 flex flex-col items-center justify-center flex-grow z-10">
        ...
        <div className="w-full mt-12 p-8 bg-gradient-to-b from-[#161616] to-[#0a0a0a] border border-[#333] rounded-2xl shadow-xl animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
          ...
          <div className="w-full text-center mb-8 min-h-[7rem] flex flex-col items-center justify-center">
            ...
            <p className="text-gray-400 text-sm mt-4 max-w-[90%]">Kreiramo vaš personalizovani plan treninga na osnovu vaših ciljeva, iskustva i preferencija</p>
          </div>

          {/* Animated circular AI processor */}
          <div className="flex justify-center mt-4 mb-6 relative py-4 animate-fade-in-up" style={{ animationDelay: "0.4s" }}>
            <div className="relative flex items-center justify-center">
              ...
              <div className="w-24 h-24 rounded-full bg-gradient-to-br from-[#111] to-[#222] border border-[#333] flex items-center justify-center shadow-xl">
                ...
                <div className="z-10 text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#FF6B00] to-[#FF9A00]">AI</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center justify-center gap-8 mt-10 animate-fade-in-up" style={{ animationDelay: "0.6s" }}>
          <div className="animate-float">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#FF6B00" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="drop-shadow-glow-orange">
          ...
          <div className="animate-float" style={{ animationDelay: "0.2s" }}>
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#3498db" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="drop-shadow-glow-blue">
              <path d="M22 12h-4l-3 9L9 3l-3 9H2"></path>
            </svg>
          </div>
          <div className="animate-float" style={{ animationDelay: "0.4s" }}>
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#9d4edd" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="drop-shadow-glow-purple">
              <path d="M2 4l3 12h14l3-12-6 7-4-7-4 7-6-7zm3 16h14"></path>
            </svg>
          </div>
          <div className="animate-float" style={{ animationDelay: "0.6s" }}>
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#2ecc71" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="drop-shadow-glow-green">
