          ...
          <div className="grid grid-cols-2 gap-4 mb-5">
            <div className="bg-neutral-900/50 rounded-lg p-3 border border-neutral-700">
              <div className="text-lg font-bold mb-1">
                ...
                <span className="text-orange-500">sets</span>
              </div>
            ...
            <div className="bg-neutral-900/50 rounded-lg p-3 border border-neutral-700">
              <div className="text-lg font-bold mb-1">
                ...
                <span className="text-orange-500">reps</span>
              </div>
              <div className="text-xs text-gray-400">PER SET</div>
            </div>
            <div className="bg-neutral-900/50 rounded-lg p-3 border border-neutral-700">
              <div className="text-lg font-bold mb-1">
                {workout.exercises[currentExercise].restTime}{" "}
            ...
            <div className="bg-neutral-900/50 rounded-lg p-3 border border-neutral-700">
              <div className="text-lg font-bold mb-1">
                ...
                <span className="text-orange-500">kg</span>
              </div>
            ...
            {Array.from({
              ...
              <div
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateWeight(currentExercise, setNum + 1, e.target.value)
                  }
                />
                <input
                  type="text"
                  ...
                  defaultValue={
                    setNum === 0
                      ? workout.exercises[currentExercise].reps.split("-")[0]
                      : ""
                  }
                  onChange={(e) =>
                    updateReps(currentExercise, setNum + 1, e.target.value)
                  }
                />
              </div>
            ))}
                ...
                <div className="bg-neutral-800 rounded-xl p-4">
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="text-orange-500">•</span>
                      <span className="text-sm">
                        Banana or apple for quick carbs
                      </span>
                    </div>
                    <div className="flex items-center gap-2">
                      <span className="text-orange-500">•</span>
                    ...
                    <div className="flex items-center gap-2">
                      <span className="text-orange-500">•</span>
                      <span className="text-sm">
                        Meal within 2 hours: Lean protein + complex carbs
                      </span>
                    </div>
                  </div>
                </div>
