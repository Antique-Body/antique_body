...
const WorkoutPage = () => {
  ...
  const updateWeight = (exerciseIndex, setNumber, weight) => {
    setWeights(prev => ({
      ...prev,
      [`${exerciseIndex}-${setNumber}`]: weight
    }));
  };

  const updateReps = (exerciseIndex, setNumber, reps) => {
    setReps(prev => ({
      ...prev,
      [`${exerciseIndex}-${setNumber}`]: reps
    }));
  };
  ...
  }, [currentSet, completedExercises, workout]);
      ...
      <div className="max-w-[550px] mx-auto p-5 relative z-20 pb-32">
        ...
        <div className="bg-gradient-to-br from-neutral-900 to-neutral-800 rounded-xl p-5 mb-5 shadow-xl shadow-black/30 border border-neutral-800">
          <div className="flex justify-between items-center mb-4 pb-3 border-b border-neutral-800">
            ...
            <div className="workout-progress">{completedExercises.length + 1}/{workout.exercises.length}</div>
          </div>
          ...
          <div className="h-1.5 bg-neutral-800 rounded-sm mb-5 overflow-hidden">
            <div
              ...
              style={{ width: `${workoutProgress}%` }}></div>
          </div>
        ...
        <div className="relative overflow-hidden bg-neutral-800/70 rounded-xl p-5 mb-5 border border-neutral-700 before:content-[''] before:absolute before:top-0 before:left-0 before:w-full before:h-1 before:bg-gradient-to-r before:from-orange-500 before:to-orange-400">
          <div className="mb-4">
            <div className="text-xl md:text-2xl font-bold mb-1 flex items-center gap-3">
              <span className="text-orange-500">
                {String(currentExercise + 1).padStart(2, "0")}
              </span>{" "}
          ...
          <div className="mb-5">
            ...
            {Array.from({ length: workout.exercises[currentExercise].sets }).map((_, setNum) => (
              <div
                key={setNum}
                ...
                <input
                  ...
                  onChange={(e) => updateWeight(currentExercise, setNum + 1, e.target.value)}
                />
                <input
                  type="text"
                  className="bg-neutral-800/80 border border-neutral-600 text-white rounded-md p-2 text-sm w-full focus:outline-none focus:border-orange-500"
                  defaultValue={setNum === 0 ? workout.exercises[currentExercise].reps.split("-")[0] : ""}
                  onChange={(e) => updateReps(currentExercise, setNum + 1, e.target.value)}
                />
              </div>
            ))}
          </div>
            ...
            <div className="p-8">
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                ...
                <div className="bg-neutral-800 rounded-xl p-4">
                  ...
                  <div className="text-2xl font-bold">{workout.exercises.reduce((acc, ex) => acc + ex.sets, 0)}</div>
                </div>
              </div>
                  ...
                  <div className="bg-neutral-800 rounded-xl p-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-400">Lower Body Focus - Scheduled for tomorrow</p>
                      </div>
                    </div>
                  </div>
                  <div className="bg-neutral-800 rounded-xl p-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-400">Get 7-8 hours of sleep and stay hydrated</p>
                      </div>
                    </div>
                  </div>
                </div>
