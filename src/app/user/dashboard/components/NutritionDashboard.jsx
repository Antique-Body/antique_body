                        ...
                        <div className="space-y-4">
                            <div>
                                <div className="flex justify-between text-sm mb-2">
                                    ...
                                    <span className="font-medium">
                                        {nutritionData.currentIntake.calories} / {nutritionData.dailyGoals.calories}
                                    </span>
                                </div>
                            ...
                            <div>
                                <div className="flex justify-between text-sm mb-2">
                                    ...
                                    <span className="font-medium">
                                        {nutritionData.currentIntake.protein}g / {nutritionData.dailyGoals.protein}g
                                    </span>
                                </div>
                                <div className="h-3 bg-[#333] rounded-full overflow-hidden">
                                    <div
                            ...
                            <div>
                                <div className="flex justify-between text-sm mb-2">
                                    ...
                                    <span className="font-medium">
                                        {nutritionData.currentIntake.carbs}g / {nutritionData.dailyGoals.carbs}g
                                    </span>
                                </div>
                                <div className="h-3 bg-[#333] rounded-full overflow-hidden">
                                    <div
                            ...
                            <div>
                                <div className="flex justify-between text-sm mb-2">
                                    ...
                                    <span className="font-medium">
                                        {nutritionData.currentIntake.fats}g / {nutritionData.dailyGoals.fats}g
                                    </span>
                                </div>
                                <div className="h-3 bg-[#333] rounded-full overflow-hidden">
                                    <div
                    ...
                    <div className="bg-[#111] border border-[#333] rounded-2xl max-w-2xl w-full overflow-hidden animate-scaleIn">
                        <div className="p-6">
                            <div className="flex justify-between items-center mb-6">
                                ...
                                <button className="text-gray-400 hover:text-white" onClick={() => setShowFoodSearch(false)}>
                                    ✕
                                </button>
                            </div>
