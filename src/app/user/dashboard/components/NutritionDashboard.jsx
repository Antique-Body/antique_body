  ...
  const [nutritionData, setNutritionData] = useState({
    ...
    meals: [
      ...
      },
      {
        ...
        time: "13:00",
        foods: [
          { name: "Chicken Breast", calories: 450, protein: 55, carbs: 0, fats: 25 },
      ...
      },
      {
        ...
        foods: [
          ...
          { name: "Sweet Potato", calories: 200, protein: 2, carbs: 45, fats: 0 }
        ]
      }
    ],
    waterIntake: [
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-10">
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-full bg-[#FF6B00] bg-opacity-10 flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#FF6B00" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      <path d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path>
                    </svg>
                  </div>
                  <div className="text-left">
                    <h4 className="font-medium text-lg">Search Food</h4>
                    <p className="text-sm text-gray-400">Find food in database</p>
                  </div>
                </div>
              </button>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-gray-400">Take a photo of your meal</p>
                  </div>
                </div>
              </button>
            </div>
                      ...
                      >
                        <div>
                          ...
                          <p className="text-sm text-gray-400">
                            {food.protein}g protein • {food.carbs}g carbs • {food.fats}g fat
                          </p>
                        </div>
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div>
                <div className="flex justify-between text-sm mb-2">
                  ...
                  <span className="font-medium">{nutritionData.currentIntake.calories} / {nutritionData.dailyGoals.calories}</span>
                </div>
                <div className="h-3 bg-[#333] rounded-full overflow-hidden">
                  <div 
                    className="h-full bg-[#2ecc71] rounded-full transition-all duration-300"
                    style={{ width: `${(nutritionData.currentIntake.calories / nutritionData.dailyGoals.calories) * 100}%` }}
                  ></div>
                </div>
              </div>
              <div>
                <div className="flex justify-between text-sm mb-2">
                  ...
                  <span className="font-medium">{nutritionData.currentIntake.protein}g / {nutritionData.dailyGoals.protein}g</span>
                </div>
                <div className="h-3 bg-[#333] rounded-full overflow-hidden">
                  <div 
                    className="h-full bg-[#3498db] rounded-full transition-all duration-300"
                    style={{ width: `${(nutritionData.currentIntake.protein / nutritionData.dailyGoals.protein) * 100}%` }}
                  ></div>
                </div>
              </div>
              <div>
                <div className="flex justify-between text-sm mb-2">
                  ...
                  <span className="font-medium">{nutritionData.currentIntake.carbs}g / {nutritionData.dailyGoals.carbs}g</span>
                </div>
                <div className="h-3 bg-[#333] rounded-full overflow-hidden">
                  <div 
                    className="h-full bg-[#f1c40f] rounded-full transition-all duration-300"
                    style={{ width: `${(nutritionData.currentIntake.carbs / nutritionData.dailyGoals.carbs) * 100}%` }}
                  ></div>
                </div>
              </div>
              <div>
                <div className="flex justify-between text-sm mb-2">
                  ...
                  <span className="font-medium">{nutritionData.currentIntake.fats}g / {nutritionData.dailyGoals.fats}g</span>
                </div>
                <div className="h-3 bg-[#333] rounded-full overflow-hidden">
                  <div 
                    className="h-full bg-[#e74c3c] rounded-full transition-all duration-300"
                    style={{ width: `${(nutritionData.currentIntake.fats / nutritionData.dailyGoals.fats) * 100}%` }}
                  ></div>
                </div>
              </div>
            </div>
              ...
              <div className="bg-[#222] rounded-xl p-4">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">450 kcal • 35g protein</p>
                  </div>
                </div>
              ...
              <div className="bg-[#222] rounded-xl p-4">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">380 kcal • 28g protein</p>
                  </div>
                </div>
                <button className="w-full py-2 bg-[#3498db] hover:bg-[#2980b9] rounded-lg text-sm transition-colors">
                  Add to Log
          ...
          <div className="bg-gradient-to-br from-[#111] to-[#0a0a0a] border border-[#333] rounded-2xl p-6 hover:border-[#e74c3c] transition-all duration-300">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm text-gray-400 mb-2">Allergies & Dietary Restrictions</label>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-[#222] rounded-xl p-4">
                  <h4 className="text-sm text-gray-400 mb-2">Dietary Preferences</h4>
                  <div className="flex flex-wrap gap-2">
                    <span className="px-3 py-1 bg-[#333] rounded-full text-sm">Vegetarian</span>
                    <span className="px-3 py-1 bg-[#333] rounded-full text-sm">Gluten-Free</span>
                    <span className="px-3 py-1 bg-[#333] rounded-full text-sm">+ Add</span>
                  </div>
                </div>
                <div className="bg-[#222] rounded-xl p-4">
                  <h4 className="text-sm text-gray-400 mb-2">Health Goals</h4>
                  <div className="flex flex-wrap gap-2">
                    <span className="px-3 py-1 bg-[#333] rounded-full text-sm">Weight Loss</span>
                    <span className="px-3 py-1 bg-[#333] rounded-full text-sm">Muscle Gain</span>
                    <span className="px-3 py-1 bg-[#333] rounded-full text-sm">+ Add</span>
                  </div>
                </div>
              </div>
