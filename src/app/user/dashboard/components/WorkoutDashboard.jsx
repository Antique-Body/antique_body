...
export default function WorkoutDashboard() {
      ...
      },
      {
        ...
        exercises: [
          ...
          },
          {
            ...
            reps: "12 each",
            restTime: "60-90 sec",
            notes: "Focus on lat contraction",
          },
          {
            name: "Face Pulls",
            sets: 3,
      ...
      },
      {
        ...
        exercises: [
          ...
          },
          {
            ...
            reps: "15-20",
            restTime: "60 sec",
            notes: "Pause at bottom position",
          },
          {
            name: "Cable Crunches",
            sets: 3,
  ...
  const trainingTypes = [
    ...
    },
    {
      ...
      description:
        "Enhance your speed, agility and reaction time with sprint training and dynamic movement patterns.",
      color: "#3498db",
      preferences: {
    ...
    },
    {
      ...
      description:
        "Build raw strength with heavy compound movements and progressive overload principles.",
      color: "#e74c3c",
      preferences: {
        location: "Gym",
        equipment: "Full Equipment",
    ...
    },
    {
      ...
      description:
        "Improve everyday movement patterns with functional exercises that translate to daily activities.",
      color: "#2ecc71",
      preferences: {
        location: "Gym/Home",
        equipment: "Mixed",
    ...
    },
    {
      ...
      summary: "Burn & Tone",
      description:
        "High-intensity interval training combined with cardio to maximize calorie burn and promote fat loss.",
      color: "#9b59b6",
      preferences: {
        location: "Gym/Home",
        equipment: "Minimal",
    ...
    },
    {
      ...
      description:
        "Strategic volume and progressive overload training designed to maximize muscle growth and definition.",
      color: "#f1c40f",
      preferences: {
        location: "Gym",
        equipment: "Full Equipment",
    ...
    },
    {
      ...
      icon: "repeat",
      summary: "Stamina & Resilience",
      description:
        "Build cardiovascular stamina and muscular endurance for long-duration activities and improved recovery rates.",
      color: "#1abc9c",
      preferences: {
        location: "Gym/Outdoor",
        equipment: "Minimal",
      ...
      exercises: [
        { name: "Long Distance Running", sets: 1, reps: "5-10 km", restTime: "N/A" },
        { name: "Circuit Training", sets: 5, reps: "1 min each", restTime: "30 sec" },
        { name: "Rowing Machine", sets: 3, reps: "2000m", restTime: "2 min" },
        { name: "Bodyweight Supersets", sets: 4, reps: "15-20", restTime: "45 sec" },
    ...
    },
    {
      ...
      icon: "move",
      summary: "Improve Range of Motion",
      description:
        "Enhance joint mobility, flexibility and movement patterns to improve performance and reduce injury risk.",
      color: "#00bcd4",
      preferences: {
        location: "Home/Gym",
        equipment: "Minimal",
      ...
      exercises: [
        { name: "Dynamic Stretching Routine", sets: 2, reps: "10 each", restTime: "10 sec" },
        { name: "Yoga Flow Sequence", sets: 1, reps: "15-20 min", restTime: "N/A" },
        { name: "Joint Mobility Series", sets: 2, reps: "8-10 each", restTime: "15 sec" },
        { name: "Foam Rolling", sets: 1, reps: "60 sec per area", restTime: "10 sec" },
        { name: "Active Isolated Stretching", sets: 2, reps: "10 each side", restTime: "10 sec" },
      ],
    },
    {
      id: 9,
      ...
      description: 
        "Targeted training designed to improve performance in specific sports through specialized movement patterns.",
      color: "#e91e63",
      preferences: {
        location: "Gym/Field",
        equipment: "Mixed",
      ...
      exercises: [
        { name: "Agility Ladder Drills", sets: 3, reps: "45 sec", restTime: "60 sec" },
        { name: "Reactive Jumping", sets: 4, reps: "8-10", restTime: "90 sec" },
        { name: "Change of Direction Sprints", sets: 5, reps: "20 yards", restTime: "60 sec" },
        { name: "Sport Technique Drills", sets: 3, reps: "5 min", restTime: "90 sec" },
        { name: "Resistance Band Movements", sets: 3, reps: "12-15", restTime: "60 sec" },
      ],
    },
    {
      id: 10,
      ...
      icon: "sunrise",
      summary: "Holistic Wellness",
      description:
        "Integrate mental focus with physical movement to improve body awareness, posture and stress management.",
      color: "#9c27b0",
      preferences: {
      ...
      exercises: [
        { name: "Yoga Flow", sets: 1, reps: "20 min", restTime: "N/A" },
        { name: "Meditation", sets: 1, reps: "10 min", restTime: "N/A" },
        { name: "Pilates Core Series", sets: 2, reps: "10-12 each", restTime: "30 sec" },
        { name: "Tai Chi Movement", sets: 1, reps: "15 min", restTime: "N/A" },
        { name: "Breathwork Exercises", sets: 3, reps: "3 min", restTime: "30 sec" },
      ],
    },
  ];
  ...
  const featuredWorkouts = [
    {
      ...
      users: 856,
      description:
        "A comprehensive strength program designed to increase your power and muscle mass over 30 days",
    ...
    },
    {
      ...
      users: 1243,
      description:
        "High-intensity interval training focused on core strength and cardiovascular endurance",
    ...
    },
    {
      ...
      users: 972,
      description:
        "A balanced full-body workout program perfect for beginners looking to improve overall fitness",
    ...
    },
    {
      ...
      users: 1568,
      description:
        "Build strength and muscle using only your bodyweight with progressive techniques for all fitness levels",
      schedule: "4-5 days per week",
      ...
      workouts: [
        {
          ...
          exercises: [
            { name: "Push-up Variations", sets: 4, reps: "Max", rest: "60 sec" },
            { name: "Pull-up Progressions", sets: 4, reps: "Max", rest: "90 sec" },
            { name: "Pike Push-ups", sets: 3, reps: "10-15", rest: "60 sec" },
            { name: "Bodyweight Rows", sets: 3, reps: "12-15", rest: "60 sec" },
            { name: "Diamond Push-ups", sets: 3, reps: "Max", rest: "60 sec" },
          ],
        },
        {
          name: "Lower Body & Core",
          exercises: [
            { name: "Pistol Squat Progressions", sets: 3, reps: "6-8 each", rest: "60 sec" },
            { name: "Glute Bridge Variations", sets: 3, reps: "15-20", rest: "45 sec" },
            { name: "Jumping Lunges", sets: 4, reps: "10 each", rest: "60 sec" },
            { name: "L-Sit Progressions", sets: 3, duration: "Max hold", rest: "60 sec" },
            { name: "Hollow Body Holds", sets: 3, duration: "30-45 sec", rest: "45 sec" },
          ],
        },
      ],
    },
    {
      ...
      users: 762,
      description:
        "Improve joint mobility, flexibility and movement quality for better performance in all activities",
      ...
      workouts: [
        {
          ...
          exercises: [
            { name: "Shoulder CARs", sets: 2, reps: "5 each direction", rest: "30 sec" },
            { name: "Thoracic Bridge", sets: 3, duration: "45 sec", rest: "30 sec" },
            { name: "Wall Slides", sets: 3, reps: "10-12", rest: "30 sec" },
            { name: "Scapular Push-ups", sets: 2, reps: "12-15", rest: "30 sec" },
            { name: "Wrist Mobility Sequence", sets: 2, duration: "60 sec", rest: "30 sec" },
          ],
        },
        {
          name: "Lower Body Mobility",
          exercises: [
            { name: "Hip CARs", sets: 2, reps: "5 each direction", rest: "30 sec" },
            { name: "Lizard Pose Progression", sets: 2, duration: "60 sec each", rest: "30 sec" },
            { name: "Single-Leg RDL", sets: 3, reps: "8-10 each", rest: "45 sec" },
            { name: "Ankle Mobility Routine", sets: 2, reps: "10 each", rest: "30 sec" },
            { name: "90/90 Hip Switches", sets: 2, reps: "8-10 each", rest: "45 sec" },
          ],
        },
      ],
    },
    {
      ...
      users: 684,
      description:
        "Explosive power training program designed to increase athletic performance, speed and strength",
      schedule: "3-4 days per week",
      equipment: "Full gym, boxes, medicine balls",
      workouts: [
        {
          name: "Power Development - Upper",
          exercises: [
            { name: "Medicine Ball Chest Throws", sets: 4, reps: "8", rest: "90 sec" },
            { name: "Plyo Push-ups", sets: 4, reps: "8-10", rest: "90 sec" },
            { name: "Pull-up to Muscle-up", sets: 4, reps: "3-5", rest: "2 min" },
            { name: "Landmine Presses", sets: 3, reps: "6-8 each", rest: "90 sec" },
            { name: "Battle Rope Slams", sets: 3, duration: "30 sec", rest: "60 sec" },
          ],
        },
        {
          name: "Power Development - Lower",
          exercises: [
            { name: "Box Jumps", sets: 5, reps: "5", rest: "2 min" },
            { name: "Depth Jumps", sets: 4, reps: "6", rest: "2 min" },
            { name: "Power Cleans", sets: 4, reps: "5", rest: "2 min" },
            { name: "Jump Squats", sets: 3, reps: "10", rest: "90 sec" },
            { name: "Lateral Bound Jumps", sets: 3, reps: "6 each", rest: "90 sec" },
          ],
        },
      ],
    },
                ...
                <div key={index} className="bg-[#222] rounded-xl p-6">
                  ...
                  <div className="space-y-4">
                    {workout.exercises.map((exercise, exIndex) => (
                      <div
                        key={exIndex}
                        className="flex items-center justify-between p-3 bg-[#333] rounded-lg">
                        <div>
                  ...
                  {workout.rounds && (
                    <div className="mt-4 text-sm text-gray-400">
                      Complete {workout.rounds} rounds • Rest{" "}
                      {workout.restBetweenRounds} between rounds
                    </div>
                  )}
                </div>
              ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
            ...
            <div className="bg-gradient-to-br from-[#111] to-[#0a0a0a] border border-[#333] rounded-2xl p-6">
              ...
              <p className="text-gray-400 text-sm mb-3">
                Scheduled for tomorrow, 5:30 PM
              </p>
