...
import { FrequencySelector, InjuryLocationSelector, MeasurementsInput } from "@components/custom";
...
const SettingsDashboard = () => {
  ...
  const renderTrainingStepContent = useCallback((step) => {
    ...
    if (step.isMeasurementsStep) {
      return (
        <MeasurementsInput
          onSelect={handleMeasurementsSelect}
        />
      );
    }
        ...
        {step.options.map((option) => (
          <button
            ...
            className={`p-6 bg-[#222] rounded-xl hover:bg-[#333] transition-all duration-300 group text-left ${
              trainingSettings[step.field] === option.value ? "border-2 border-[#FF6B00]" : "border border-[#333]"
            }`}
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">{t(option.description)}</p>
              </div>
            </div>
          </button>
        ))}
  ...
  }, [trainingSettings, handleTrainingOptionSelect, handleInjuryLocations, handleFrequencySelect, handleMeasurementsSelect, t]);
      ...
      <div className="space-y-6">
        {activeSection === "training" && (
          <div className="space-y-6">
            {stepConfig.map((step) => (
              shouldShowStep(step) && (
                <div key={step.stepNumber} className="bg-gradient-to-br from-[#111] to-[#0a0a0a] border border-[#333] rounded-2xl p-6">
            ...
            <div className="bg-gradient-to-br from-[#111] to-[#0a0a0a] border border-[#333] rounded-2xl p-6">
              ...
              <div className="space-y-4">
                {Object.entries({
                  ...
                  progressUpdates: "Weekly progress and achievement notifications",
                  nutritionReminders: "Meal tracking and water intake reminders",
                  communityUpdates: "News and updates from your fitness community"
                }).map(([key, description]) => (
