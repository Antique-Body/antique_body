              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    <p className="font-medium">{food.nutrition.calories} kcal</p>
              ...
              {!selectedImage ? (
                <div className="border-2 border-dashed border-[#333] rounded-xl p-8 text-center">
                  <div className="mb-4">
                    ...
                    <p className="text-gray-400 mb-2">Take a photo or upload an image of your food</p>
                    <input
                      type="file"
                      accept="image/*"
                        ...
                        <div key={index} className="bg-[#1A1A1A] rounded-xl p-4">
                          <div className="flex justify-between items-start mb-2">
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                <h4 className="font-medium">{food.name}</h4>
                                <p className="text-sm text-gray-400">Confidence: {(food.confidence * 100).toFixed(1)}%</p>
                              </div>
                            </div>
                            <button
                          ...
                          <div className="grid grid-cols-4 gap-2 text-center">
                            <div className="bg-[#222] rounded-lg p-2">
                              ...
                              <p className="font-medium">{food.nutrition.calories}</p>
                            </div>
                            <div className="bg-[#222] rounded-lg p-2">
                              <p className="text-sm text-gray-400">Protein</p>
                              <p className="font-medium">{food.nutrition.protein}g</p>
                            </div>
                            <div className="bg-[#222] rounded-lg p-2">
                              <p className="text-sm text-gray-400">Carbs</p>
                              <p className="font-medium">{food.nutrition.carbs}g</p>
                            </div>
                            <div className="bg-[#222] rounded-lg p-2">
                              <p className="text-sm text-gray-400">Fat</p>
                              <p className="font-medium">{food.nutrition.fat}g</p>
                            </div>
                          </div>
                        </div>
                      ))}
