      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-gradient-to-br from-[#111] to-[#0a0a0a] border border-[#333] rounded-2xl p-6">
          ...
          <div className="text-3xl font-bold text-[#e74c3c] mb-2">
            {healthData.heartRate.current} BPM
          </div>
            ...
            <div className="flex h-full items-end gap-1">
              {healthData.heartRate.history.map((rate, index) => (
                <div
                  ...
                  style={{ height: `${(rate / healthData.heartRate.max) * 100}%` }}
                ></div>
              ))}
            </div>
          </div>
        ...
        <div className="bg-gradient-to-br from-[#111] to-[#0a0a0a] border border-[#333] rounded-2xl p-6">
          ...
          <div className="text-3xl font-bold text-[#9b59b6] mb-2">
            {healthData.sleep.lastNight.total}h
          </div>
            ...
            <div>
              ...
              <div className="h-1 bg-[#333] rounded-full">
                <div
                  ...
                  style={{ width: `${(healthData.calories.active / healthData.calories.goal) * 100}%` }}
                ></div>
              </div>
            </div>
            <div>
              ...
              <div className="h-1 bg-[#333] rounded-full">
                <div
                  className="h-full bg-[#2ecc71] rounded-full"
                  style={{ width: `${(healthData.activity.activeMinutes / healthData.activity.goal) * 100}%` }}
                ></div>
              </div>
            </div>
          </div>
