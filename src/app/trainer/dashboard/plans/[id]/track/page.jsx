...
export default function PlanTrackingOverviewPage({ params }) {
    ...
    if (assignmentsParam) {
      try {
        const parsedAssignments = JSON.parse(
          decodeURIComponent(assignmentsParam)
        );
  ...
  const handleClientSelect = (assignment) => {
    router.push(
      `/trainer/dashboard/clients/${assignment.clientId}/plans/${assignment.assignedPlanId}?type=${planType}`
    );
  };
      ...
      <main className="py-6 sm:py-8 px-4 sm:px-6 max-w-7xl mx-auto">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-4 text-xs text-gray-500">
                  <span>
                    Duration: {planDetails.duration || "Not specified"}
                  </span>
                  <span>•</span>
                  <span>
                    Assigned to {assignments.length} client
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-400 text-sm mb-6">
            Select a client to view their individual progress and tracking
            details
          </p>
        </div>
