...
import { EditTrainingPlanForm } from "@/components/custom/dashboard/trainer/pages/plans/training/edit";
            ...
            schedule: [
              {
                ...
                day: "Monday",
                description:
                  "Focus on explosive movements and compound exercises for the upper body",
                exercises: [
                  {
                    id: crypto.randomUUID(),
                    name: "Bench Press",
              ...
              },
              {
                ...
                day: "Wednesday",
                description:
                  "Heavy compound movements for lower body strength development",
                exercises: [
                  {
                    id: crypto.randomUUID(),
                    name: "Barbell Squat",
