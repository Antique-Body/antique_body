            ...
            <div className="relative z-10 flex items-center justify-center min-h-screen">
                ...
                >
                        ...
                        <div className="text-center">
                            ...
                            {autoRedirect ? (
                                <div className="mb-6">
                                    ...
                                    <button onClick={cancelRedirect} className="text-sm text-gray-400 hover:text-white">
                                        {t("cancel_redirect")}
                                    </button>
                                </div>
                            ) : (
                    ...
                    <div className="mt-6 pt-4 border-t border-zinc-800">
                        <button onClick={() => setShowDebug(!showDebug)} className="text-xs text-gray-500 hover:text-gray-400">
