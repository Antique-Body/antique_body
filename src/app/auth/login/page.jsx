                ...
                >
                    {showForgotPassword ? (
                        <div className="w-full">
                            <h2 className="text-xl font-semibold mb-4 text-center">{t("auth.password_reset.title")}</h2>
                            <form onSubmit={handleForgotPassword} className="space-y-4">
                                ...
                                {forgotPasswordStatus === "error" && (
                                    <p className="text-red-500 text-sm">{t("auth.password_reset.failed")}</p>
                                )}
                                {forgotPasswordStatus === "success" && (
                                    <p className="text-green-500 text-sm">{t("auth.password_reset.instructions")}</p>
                                )}
                                <Button
                                    type="submit"
                                    ...
                                    fullWidth
                                >
                                    {forgotPasswordStatus === "sending" ? t("auth.form.sending") : t("auth.form.submit")}
                                </Button>
                                {forgotPasswordStatus === "success" && (
                                    <Button
                                        type="button"
                        ...
                        <>
                            <h1 className="text-2xl font-bold mb-2 text-center">{t("auth.login.welcome_back")}</h1>
                            <p className="text-gray-400 mb-8 text-center">{t("auth.login.sign_in_to_account")}</p>
                            ...
                            <div className="mt-4 flex justify-end">
                                <Button type="button" onClick={() => setShowForgotPassword(true)} variant="ghostOrange">
