                ...
                >
                    {registrationSuccess ? (
                        <div className="text-center">
                            ...
                            <h2 className="text-2xl font-semibold mb-4 text-green-500">{t("registration_successful")}</h2>
                            <p className="text-gray-400 mb-2">{t("auth.register.verification.email_sent_to")}</p>
                            <p className="font-medium text-white mb-6">{registeredEmail}</p>
                            <p className="text-gray-400 mb-6">{t("check_inbox_verification")}</p>

                            {resendSuccess ? (
                                <div className="mb-6 p-3 bg-green-500/10 rounded-lg">
                                    <p className="text-green-500">{t("verification_email_sent_again")}</p>
                                </div>
                            ) : resendError ? (
                        ...
                        <>
                            <p className="text-gray-400 mb-8 text-center">{t("auth.register.join_fitness_community")}</p>
                            ...
                            <div className="mt-6 text-center">
                                <p className="text-gray-400">
                                    ...
                                    <Link href="/auth/login" className="text-[#ff7800] hover:text-[#ff5f00] transition-colors">
