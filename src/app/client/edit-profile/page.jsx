...
import {
  AnimatedTabContent,
  DashboardTabs,
} from "@/components/custom/DashboardTabs";
        ...
        <motion.div variants={fadeIn}>
          <Card
            ...
            <form onSubmit={handleSubmit} className="relative space-y-10">
              ...
              <AnimatedTabContent
                isActive={activeSection === "fitnessGoals"}
                tabId="fitnessGoals">
                <FitnessGoals
                  clientData={clientData}
                  handleChange={handleChange}
                  ...
                  addGoal={() =>
                    handleArrayItemChange("fitnessGoals", newGoal, true)
                  }
                  removeGoal={(goal) =>
                    handleArrayItemChange("fitnessGoals", goal, false)
                  }
                />
              </AnimatedTabContent>

              <AnimatedTabContent
                isActive={activeSection === "measurements"}
                tabId="measurements">
                <PhysicalMeasurements
                  clientData={clientData}
                  handleChange={handleChange}
              ...
              <AnimatedTabContent
                isActive={activeSection === "medicalInfo"}
                tabId="medicalInfo">
                <MedicalInformation
                  clientData={clientData}
                  ...
                  addAllergy={() =>
                    handleArrayItemChange("allergies", newAllergy, true)
                  }
                  removeAllergy={(allergy) =>
                    handleArrayItemChange("allergies", allergy, false)
                  }
                  newInjury={newInjury}
                  setNewInjury={setNewInjury}
                  addInjury={() =>
                    handleArrayItemChange("injuries", newInjury, true)
                  }
                  removeInjury={(injury) =>
                    handleArrayItemChange("injuries", injury, false)
                  }
                />
              </AnimatedTabContent>

              <AnimatedTabContent
                isActive={activeSection === "dietaryPrefs"}
                tabId="dietaryPrefs">
                <DietaryPreferences
                  clientData={{
                    ...clientData,
                    ...
                    proteinPercentage:
                      clientData.dietaryPreferences.macros.protein,
                  ...
                  removeRestriction={(restriction) => {
                    setClientData({
                      ...
                      dietaryPreferences: {
                        ...clientData.dietaryPreferences,
                        restrictions:
                          clientData.dietaryPreferences.restrictions.filter(
                            (r) => r !== restriction
                          ),
                      },
                    });
                  ...
                  removeIntolerance={(intolerance) => {
                    setClientData({
                      ...
                      dietaryPreferences: {
                        ...clientData.dietaryPreferences,
                        intolerances:
                          clientData.dietaryPreferences.intolerances.filter(
                            (i) => i !== intolerance
                          ),
                      },
                    });
              ...
              <div className="flex justify-between border-t border-[#333] pt-8">
                ...
                <div className="flex gap-4">
                  ...
                  <Button
                    ...
                    <span
                      className={`transition-opacity ${saveIndicator ? "opacity-0" : "opacity-100"}`}>
                      Save Changes
                    </span>
                    <span
