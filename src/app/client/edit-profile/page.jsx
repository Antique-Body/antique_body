...
import {
  ...
  HealthInfo,
  ClientLocation,
} from "@/components/custom/dashboard/client/edit-profile";
...
const ClientEditProfilePage = () => {
  ...
  const sections = [
    ...
    { id: "activities", label: "Activities & Languages", badgeCount: 0 },
    { id: "health", label: "Health Info", badgeCount: 0 },
    { id: "contactLocation", label: "Location", badgeCount: 0 },
  ];
