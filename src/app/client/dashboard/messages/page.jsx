...
import ClientChatInterface from "@/components/custom/client/dashboard/pages/messages/ClientChatInterface";
...
export default function MessagesPage() {
  ...
  const handleSendMessage = (message, conversationId) => {
    ...
    console.log("Client sending message:", message, "to conversation:", conversationId);
  };
