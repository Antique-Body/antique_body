...
export default function NutritionPage() {
    ...
    const handleSaveMeal = (mealData) => {
        if (selectedMealForEdit) {
            ...
            setMeals(meals.map((meal) => (meal.id === selectedMealForEdit.id ? { ...mealData, id: meal.id } : meal)));
        } else {
            // Add new meal
    ...
    const handleAddAnalyzedMeal = (foodItem, mealTime) => {
        ...
        const existingMealIndex = meals.findIndex((meal) => meal.name.toLowerCase() === mealTime.toLowerCase());
    ...
    return (
        <div className="space-y-6">
            ...
            <div ref={hydrationRef}>
                <HydrationTracker waterIntake={waterIntake} onAddWater={addWater} userData={userData} />
            </div>
