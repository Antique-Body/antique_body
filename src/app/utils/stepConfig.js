    ...
    options: [
      {
        ...
        emoji: "🏋️",
        title: "In the Gym",
        icon: <ParthenonIcon className="h-12 w-12" />,
      },
      {
        value: "outside",
        emoji: "🌳",
        title: "Outside",
        icon: <ColosseumIcon className="h-12 w-12" />,
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        icon: <ColumnIcon className="h-12 w-12" />,
      },
      {
        value: "no-equipment",
        emoji: "🧘",
        ...
        icon: <VaseIcon className="h-12 w-12" />,
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        icon: <RunnerIcon className="h-12 w-12" />,
      },
      {
        value: "intermediate",
        emoji: "🔄",
        ...
        icon: <DiscusIcon className="h-12 w-12" />,
      },
      {
        value: "advanced",
        emoji: "💪",
