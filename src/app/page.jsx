...
const updatedFeatures = [
    ...
    },
    {
        ...
        icon: <Icon icon="mdi:abacus" className="text-3xl text-[#FF6B00] flex items-center justify-center" />,
                                        ...
                                        {[
                                            ...
                                            >
                                                <div className="w-8 h-8 rounded-full bg-[#FF6B00]/20 flex items-center justify-center flex-shrink-0">
                                                    <Icon icon={benefit.icon} className="text-[#FF6B00]" />
                                                </div>
                                    ...
                                    >
                                        <div className="flex items-center gap-3">
                                            <div className="p-2 rounded-full bg-[#FF6B00]/20 flex-shrink-0">
                                                <Icon icon="mdi:alpha-g-box" className="text-xl text-[#FF6B00]" />
                                            </div>
                                            <div>
