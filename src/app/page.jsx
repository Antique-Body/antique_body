    ...
    return (
        <main className="min-h-screen bg-[#0a0a0a] text-white relative">
            ...
            <div className="relative z-10 max-w-4xl mx-auto px-5 py-20 text-center">
                ...
                <div className="text-xl mb-8 text-gray-300">{t("home_subtitle")}</div>

                <div className="grid md:grid-cols-3 gap-8 mb-12">
                    <div className="bg-[#1a1a1a] p-6 rounded-lg border border-[#333]">
                        <h3 className="text-xl font-semibold mb-3 text-[#ff7800]">{t("personalized_training_title")}</h3>
                        <p className="text-gray-300">{t("personalized_training_description")}</p>
                    </div>

                    <div className="bg-[#1a1a1a] p-6 rounded-lg border border-[#333]">
                        <h3 className="text-xl font-semibold mb-3 text-[#ff7800]">{t("expert_guidance_title")}</h3>
                        <p className="text-gray-300">{t("expert_guidance_description")}</p>
                    </div>

                    <div className="bg-[#1a1a1a] p-6 rounded-lg border border-[#333]">
                        <h3 className="text-xl font-semibold mb-3 text-[#ff7800]">{t("ancient_wisdom_title")}</h3>
                        <p className="text-gray-300">{t("ancient_wisdom_description")}</p>
                    </div>
                </div>
