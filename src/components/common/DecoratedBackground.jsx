...
import { svgData } from "../../app/utils/svgData";
    ...
    <div
      ...
      <div
        ...
        style={{
          filter:
            "brightness(0) saturate(100%) invert(56%) sepia(83%) saturate(1500%) hue-rotate(360deg) brightness(100%) contrast(106%)",
          backgroundImage: svgData.runner,
        }}></div>
      ...
      <div
        className="absolute w-[80px] h-[120px] bottom-0 left-[30%] transform -translate-y-[30%] bg-contain bg-no-repeat bg-center opacity-40"
        style={{
          filter:
            "brightness(0) saturate(100%) invert(56%) sepia(83%) saturate(1500%) hue-rotate(360deg) brightness(100%) contrast(106%)",
