...
export const SpinnerIcon = ({ size = 24, className = "", ...props }) => (
    <svg className={`animate-spin h-5 w-5 ${className}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
...
export const BrandLogoIcon = ({ className = "h-80 w-80", fill = "currentColor", ...props }) => (
