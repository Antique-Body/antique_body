        ...
        <div className="fixed inset-0 z-[200] bg-black/90 backdrop-blur-md flex flex-col items-center justify-center">
            ...
            <div className="relative mb-8">
                ...
                <div className="relative w-20 h-20">
                    ...
                    <div className={`absolute inset-0 m-auto w-3 h-3 bg-${selectedRole}-500 rounded-full`}></div>
                </div>
            </div>

            {/* Loading text */}
            <h3 className={`text-2xl font-bold mb-3 bg-gradient-to-r ${config.gradient} bg-clip-text text-transparent`}>
                {t(roleTitle)}
            </h3>
            ...
            <div className="w-48 h-1 bg-white/10 rounded-full mt-6 overflow-hidden">
                <div className={`h-full w-1/3 bg-gradient-to-r ${config.gradient} rounded-full`}></div>
            </div>
        </div>
    );
}
