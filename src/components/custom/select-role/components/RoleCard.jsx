    ...
    return (
        <div
            className={`
                ...
                ${
                    isSelected
                        ? "ring-2 ring-" + role + "-500 shadow-lg shadow-" + role + "-500/30"
        ...
        >
            ...
            <div className="absolute inset-0 overflow-hidden">
                ...
                {isSelected && <div className={`absolute inset-0 bg-gradient-to-br ${config.gradient} opacity-10`}></div>}
            </div>
            ...
            <div className="relative z-10 p-6 flex flex-col h-full">
                ...
                <div className="flex items-center gap-3 mb-5">
                    ...
                    <div className="flex gap-1.5 ml-auto">
                        {config.features.slice(0, 2).map((feature, idx) => (
                            ...
                            >
                                <span className={`mdi ${feature.icon} text-sm`} style={{ color: config.color }}></span>
                                <span className="truncate max-w-[80px]">{t(feature.text).split(" ")[0]}</span>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                {/* Description text */}
                <p className="text-gray-300 mb-5 text-sm leading-relaxed line-clamp-3">{t(config.description)}</p>
                ...
                <div className="mt-auto pt-3">
                    ...
                    >
                        ...
                        <span>{isSelected ? t("role.selection.selected") : t("role.selection.select_role")}</span>
                        {isSelected ? (
