    ...
    if (!showEmailForm) {
        return (
            <div className="space-y-4 w-full">
                ...
                >
                    {isLogin ? t("auth.login.continue_with_email_phone") : t("auth.register.register_with_email_phone")}
                </Button>
                ...
                <Button
                    ...
                    leftIcon={<GoogleIcon />}
                >
                    {isLogin ? t("auth.login.continue_with_google") : t("auth.register.register_with_google")}
                </Button>
                <Button
                ...
                >
                    {isLogin ? t("auth.login.continue_with_facebook") : t("auth.register.register_with_facebook")}
                </Button>
            </div>
        );
    }
