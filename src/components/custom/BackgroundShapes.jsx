...
export const BackgroundShapes = () => (
  <div className="fixed z-10 h-full w-full overflow-hidden">
    {/* Parthenon at top */}
    <div
      className="-translate-y-2/5 absolute left-1/2 top-0 h-20 w-48 -translate-x-1/2 opacity-40 transition-all duration-500 ease-in-out hover:-translate-y-1/3 hover:opacity-60"
      style={{
    ...
    {/* Discus thrower */}
    <div
      className="hover:rotate-5 absolute right-[5%] top-1/3 h-24 w-24 transition-transform duration-500 ease-in-out hover:scale-105"
      style={{
    ...
    {/* Colosseum at bottom */}
    <div
      className="translate-y-2/5 absolute bottom-0 left-1/2 h-24 w-48 -translate-x-1/2 opacity-40 transition-all duration-500 ease-in-out hover:translate-y-1/3 hover:opacity-60"
      style={{
    ...
    {/* Runner on left */}
    <div
      className="absolute left-[5%] top-1/2 h-28 w-20 -translate-y-1/2 transition-transform duration-500 ease-in-out hover:-translate-y-[48%] hover:translate-x-[5px]"
      style={{
