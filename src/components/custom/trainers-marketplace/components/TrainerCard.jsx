    ...
    return (
        <motion.div
            ...
            className={`relative group rounded-xl overflow-hidden transition-all duration-300 bg-gradient-to-b from-zinc-900 to-black border flex flex-col h-full ${
                isHovered ? "border-[#FF6B00]/50 shadow-lg shadow-[#FF6B00]/10" : "border-zinc-800"
            }`}
        ...
        >
            ...
            <div className="relative h-60 overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-5">
                    <h3 className="text-xl font-bold text-white mb-2 line-clamp-1">{trainer.name || "Unnamed Trainer"}</h3>
                    <p className="text-sm text-zinc-300 flex items-center">
                        <Icon icon="mdi:map-marker" className="w-4 h-4 text-[#FF6B00] mr-2 flex-shrink-0" />
                        <span className="line-clamp-1">{trainer.location || "Location unknown"}</span>
                    </p>
                </div>
            </div>
            ...
            <div className="p-5 flex-1 flex flex-col">
                ...
                <div>
                    ...
                    <div className="flex flex-wrap justify-between items-center mb-4 gap-2">
                        <div className="flex items-center">
                            ...
                            <span className="text-zinc-400 text-xs ml-1">({trainer.reviewCount || 0})</span>
                        </div>
                    ...
                    <div className="flex flex-wrap gap-1.5 mb-5 max-h-[50px] overflow-y-auto">
                        {trainer.tags && trainer.tags.length > 0 ? (
                            ...
                            <span className="text-xs bg-zinc-800 text-zinc-500 px-2.5 py-1 rounded-full">No tags</span>
                        )}
                    </div>
                </div>
                ...
                <div className="flex gap-3 mt-auto">
                    <Button variant="orangeFilled" size="small" className="flex-1 min-h-[40px] px-4" onClick={onClick}>
                        View Profile
                    </Button>
            ...
            <motion.div
                ...
                animate={{
                    boxShadow: isHovered ? "0 0 20px 1px rgba(255, 107, 0, 0.2)" : "0 0 0px 0px rgba(255, 107, 0, 0)",
                }}
