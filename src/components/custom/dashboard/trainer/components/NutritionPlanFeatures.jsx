    ...
    <div className="space-y-6">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {goalConfig && (
            <div
              className={`p-4 rounded-xl ${goalConfig.bgColor} ${goalConfig.borderColor} border`}
            >
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  ...
                  <p className={`${goalConfig.color} font-medium`}>
                    {goalConfig.label}
                  </p>
                </div>
              </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {keyFeatures.map((feature, index) => (
              <div
                key={index}
                className="flex items-center gap-3 p-3 bg-zinc-700/20 rounded-lg"
              >
        ...
        >
          ...
          <div className="space-y-4">
            {timeline.map((phase, index) => (
              <div
                key={index}
                className="flex gap-4 p-4 bg-zinc-700/20 rounded-xl"
              >
