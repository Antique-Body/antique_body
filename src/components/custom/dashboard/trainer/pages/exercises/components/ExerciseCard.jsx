      ...
      <div className="flex h-full flex-col">
        ...
        <div className="relative h-48 w-full overflow-hidden">
          <div className="relative h-full w-full">
            <Image 
              src={imageUrl || "/images/placeholder-exercise.jpg"} 
              alt={name}
              fill
            ...
            <div className="flex justify-between">
              <div>
                <span className={`inline-block rounded-md px-2 py-1 text-xs font-semibold ${
                  type === "strength" ? "bg-purple-900/60 text-purple-200" : 
                  type === "bodyweight" ? "bg-green-900/60 text-green-200" : 
              ...
              <div>
                <span className={`ml-2 inline-block rounded-md px-2 py-1 text-xs font-semibold ${
                  location === "gym" ? "bg-orange-900/60 text-orange-200" : "bg-cyan-900/60 text-cyan-200"
                }`}>
        ...
        <div className="p-5">
          ...
          <div className="mb-3 flex items-center text-sm text-gray-400">
            <Icon icon="mdi:map-marker" width={14} height={14} className="mr-2" />
          ...
          <div className="mb-3 flex items-center gap-2">
            ...
            <span className={`rounded-md ${getLevelBadgeColor(level)} px-2 py-1 text-sm`}>
