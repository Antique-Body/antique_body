...
} from "@/components/custom/dashboard/shared/chat";
...
const trainerMockData = {
  conversations: [
    ...
    },
    {
      ...
      avatar:
        "https://ui-avatars.com/api/?name=Admin+Team&background=0D8ABC&color=fff",
  ...
  messages: {
    1: [
      {
        id: "101",
        content:
          "Hi Coach! I've been reviewing the new workout program you sent.",
        time: "12:30 PM",
        isMine: false,
      },
      {
        id: "102",
        content:
          "Great! Let me know if you have any questions about the exercises.",
        time: "12:45 PM",
        isMine: true,
      },
      {
    ...
    2: [
      {
        id: "201",
        content:
          "Coach, I need to adjust my diet plan. I'm feeling too hungry in the evenings.",
      ...
      },
      {
        id: "202",
        content:
          "We can definitely make some adjustments. Try adding more protein and healthy fats to your dinner.",
      ...
      },
      {
        id: "203",
        content:
          "That helped a lot! Also, I've completed all my workouts this week!",
    ...
    3: [
      {
        id: "301",
        content:
          "Hello Alex, we've updated your trainer profile with your new certifications.",
      ...
      },
      {
        id: "302",
        content:
          "Thanks for the update. Have there been any new client applications?",
    ...
    4: [
      ...
      },
      {
        id: "402",
        content:
          "That's great to hear, Michael! Your consistency is paying off.",
            ...
            <>
              ...
              <div className="flex-grow space-y-4 overflow-y-auto p-4">
                ...
                messages[activeConversationId].length > 0 ? (
                  ...
                  <EmptyChatState
                    message={`Start the conversation with ${activeConversation.name}`}
                  />
                )}
              </div>
