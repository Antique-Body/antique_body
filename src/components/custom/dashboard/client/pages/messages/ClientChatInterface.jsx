...
const clientMockData = {
  conversations: [
    ...
    },
    {
      ...
      name: "NutritionBot",
      avatar:
        "https://ui-avatars.com/api/?name=NutritionBot&background=0D8ABC&color=fff",
      lastMessage:
        "I've analyzed your nutrition logs. You're making great progress!",
    ...
    },
    {
      ...
      lastMessage:
        "Let us know if you have any questions about your subscription.",
  ...
  messages: {
    1: [
      ...
      },
      {
        id: "103",
        content:
          "Excellent progress! Remember to track your measurements this week!",
        time: "10:45 AM",
        isMine: false,
      },
    ],
    2: [
      {
        id: "201",
        content:
          "Hello! I noticed you've consistently hit your protein targets this week.",
      ...
      },
      {
        id: "202",
        content:
          "Thanks! I've been focusing on adding more protein to each meal.",
