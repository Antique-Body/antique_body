...
export const BookingSessionModal = ({ trainer, onClose, isOpen }) => {
  ...
  const getPrimaryButtonAction = () =>
    step < 3 ? handleNext : handleBookSession;
              ...
              >
                <div className="mb-1 flex items-center gap-2">
                  <Icon
                    ...
                    height={16}
                    color={
                      sessionType === "in-person" ? "#FF6B00" : "currentColor"
                    }
                ...
                <p className="text-sm text-gray-400">
                  Face-to-face training at gym or designated location
                </p>
              </div>
              ...
              >
                <div className="mb-1 flex items-center gap-2">
                  <Icon
                    ...
                    height={16}
                    color={
                      sessionType === "virtual" ? "#FF6B00" : "currentColor"
                    }
                    className="text-gray-300"
                  />
                  <h4
                ...
                <p className="text-sm text-gray-400">
                  Remote training via video call from your location
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-5 rounded-xl border border-[#444] bg-[rgba(30,30,30,0.8)] p-5">
            <div className="mb-4 flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-1 font-medium text-[#FF6B00]">
            ...
            <div className="space-y-3 border-t border-[#333] pt-4">
              ...
              {notes && (
                <div className="pt-2">
                  ...
                  <p className="rounded bg-[rgba(20,20,20,0.5)] p-3 text-sm text-white">
                    {notes}
                  </p>
                </div>
              )}
