...
import { Card, FormField, Button } from "@/components/common";
...
export const FoodImageAnalyzer = ({ onAddToMeal, dailyGoals, dailyMacros }) => {
  ...
  const renderProgressBar = (consumed, goal, value, label, color) => {
    ...
    const getGradient = () => {
      switch (color) {
        case "bg-[#FF6B00]":
          return "bg-gradient-to-r from-[#FF5000] to-[#FF8000]";
        case "bg-blue-500":
        ...
        <Card variant="dark" width="100%" maxWidth="none" className="p-6">
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <p className="mb-6 text-base text-gray-300">
              Upload a food photo to automatically identify and calculate its
              nutritional content
            </p>
            ...
            <div className="flex items-center mt-4 text-xs text-gray-400">
              ...
              />
              <span>
                For best results, take a photo in good lighting with the food
                clearly visible
              </span>
            </div>
                    ...
                    <div className="mb-4 flex items-center justify-between">
                      ...
                      <div>
                        <p className="text-sm text-gray-400">
                          ...
                          {analysis.servingSize} {analysis.servingUnit}
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  {loading ? (
                    <div className="flex flex-col items-center">
                      ...
                      <p className="mt-2 text-sm text-gray-400">
                        This may take a few moments while we identify the food
                        and calculate its nutritional content.
                      </p>
                    </div>
                  ) : (
                    <>
                      <p className="mb-4 text-gray-300">
                        Upload and analyze a food image to see detailed
                        nutritional breakdown and how it fits into your daily
                        goals
                      </p>
                    ...
                    <div className="mb-2 flex items-center justify-between">
                      ...
                      <div className="flex items-center">
                        <Button
                          ...
                          onClick={() =>
                            setAdjustedServings(
                              Math.max(0.5, adjustedServings - 0.5)
                            )
                          }
                        ...
                        <Button
                          ...
                          className="h-8 w-8 p-0"
                          onClick={() =>
                            setAdjustedServings(adjustedServings + 0.5)
                          }
                        >
                          <span className="text-lg font-bold">+</span>
                        </Button>
                  ...
                  <div className="mb-6 grid grid-cols-4 gap-2">
                    ...
                    <div className="rounded-lg bg-[rgba(59,130,246,0.15)] p-3 text-center">
                      ...
                      <p className="text-xs text-blue-500">
                        {goalPercentages.protein}% of goal
                      </p>
                    </div>
