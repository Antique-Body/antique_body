...
export const ProfileSetupStep = ({ formData, onChange, errors }) => (
  <div className="space-y-6">
    ...
    <FormSection
      title="Profile Image"
      description="Upload your photo that trainers will see"
    ...
    >
      <FormField
        ...
        value={formData.bio}
        onChange={onChange}
        placeholder="Tell trainers about yourself! Share your fitness journey, what motivates you, your goals, lifestyle, or anything else that would help a trainer understand how to best work with you..."
        rows={6}
        error={errors.bio}
      />
      ...
      <div className="flex justify-between items-center mt-2">
        <p className="text-xs text-gray-400">
          Help trainers understand your personality and goals
        </p>
