...
const trainingTypes = [
  { id: "personal", label: "1-on-1 Personal Training", icon: "👤" },
  { id: "small_group", label: "Small Group Training (2-5)", icon: "👥" },
  { id: "group_classes", label: "Group Classes (6+)", icon: "👨‍👩‍👧‍👦" },
  { id: "online", label: "Online/Virtual Training", icon: "💻" },
  { id: "corporate", label: "Corporate Wellness", icon: "🏢" },
  { id: "sports_specific", label: "Sports-Specific Training", icon: "⚽" },
];
