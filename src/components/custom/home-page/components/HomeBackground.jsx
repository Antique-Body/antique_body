...
const HomeBackground = () => {
        ...
        const drawParticles = () => {
            ...
            particles.forEach(particle => {
                ...
                particle.pulseDirection = 
                    particle.radius >= particle.baseRadius * (1 + particle.pulseAmount) ? -1 : 
                    particle.radius <= particle.baseRadius * (1 - particle.pulseAmount * 0.5) ? 1 : 
                    particle.pulseDirection;
    ...
    return (
        <div className="home-background-container">
            ...
            <div className="dynamic-light" style={{ 
            ...
            <div className="golden-ratio">
                <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" className="golden-ratio-svg">
                    ...
                    <path d="M31.7,68.3 C31.7,52 45.3,38.4 61.6,38.4" stroke="#FF6B00" strokeOpacity="0.1" strokeWidth="1" fill="none"/>
                    <path d="M61.6,38.4 C61.6,47.5 54.3,54.9 45.1,54.9" stroke="#FF6B00" strokeOpacity="0.1" strokeWidth="1" fill="none"/>
                    <path d="M45.1,54.9 C45.1,49.8 49.2,45.6 54.4,45.6" stroke="#FF6B00" strokeOpacity="0.1" strokeWidth="1" fill="none"/>
                    <path d="M54.4,45.6 C54.4,48.5 52 50.8 49.1,50.8" stroke="#FF6B00" strokeOpacity="0.1" strokeWidth="1" fill="none"/>
                </svg>
            </div>
        </div>
    );
