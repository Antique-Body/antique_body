    ...
    const features = [
        {
            ...
            image: "https://images.unsplash.com/photo-1512054502232-10a0a035d672?q=80&w=1200&auto=format&fit=crop",
            stats: [
                { label: "Recognition accuracy", value: "97%" },
                { label: "Food database", value: "100,000+" },
            ],
            highlights: ["Real-time nutritional analysis", "Personalized dietary recommendations", "Seamless meal logging"],
        },
        {
            ...
            highlights: ["Body composition analysis", "Performance metrics dashboard", "Goal achievement tracking"],
        },
        {
            ...
            highlights: ["Client progress monitoring", "Automated program delivery", "Integrated messaging system"],
        },
    ];
            ...
            <div className="container mx-auto px-4">
                ...
                >
                    ...
                    <p className="text-lg text-gray-300 max-w-3xl mx-auto">
                        Our comprehensive platform provides all the tools you need to transform your fitness journey.
                    </p>
                </motion.div>
                        ...
                        {features.map((feature, index) => (
                            <button
                                ...
                                className={`relative px-6 py-3 rounded-xl text-sm font-medium transition-all duration-300 ${
                                    activeFeature === index ? "text-white" : "text-gray-400 hover:text-gray-200"
                                }`}
                            >
                                {activeFeature === index && (
                                    <motion.div
                                ...
                                <span className={`mdi ${feature.icon} mr-2`}></span>
                                {feature.title}
                            </button>
                        ))}
                    </motion.div>
                                    ...
                                    <div className="absolute inset-0 p-10 flex flex-col justify-end">
                                        ...
                                        >
                                            <div className="mb-6">
                                                ...
                                                >
                                                    <span
                                                        className={`mdi ${features[activeFeature].icon} text-3xl text-white`}
                                                    ></span>
                                                </div>
                            ...
                            >
                                    ...
                                    <ul className="space-y-4">
                                        {features[activeFeature].highlights.map((item, idx) => (
                                            ...
                                            >
                                                ...
                                                >
                                                    <span className="mdi mdi-check text-sm text-white"></span>
                                                </div>
                                                <div>
                                ...
                                >
                                    <div className="flex items-center gap-3 mb-3">
                                        ...
                                        >
                                            <span className="mdi mdi-play text-white"></span>
                                        </div>
                                        <h4 className="font-medium text-white">See it in action</h4>
                                    </div>
                                    <p className="text-gray-300 mb-4">
                                        Experience how this feature can transform your fitness journey. Try it today and see the
                                        difference.
                                    </p>
                                    <Link href={`/features/${features[activeFeature].id}`}>
                                        ...
                                        >
                                            Explore Feature
                                            <span className="mdi mdi-arrow-right ml-2 group-hover:translate-x-1 inline-block transition-transform"></span>
                                        </Button>
                                    </Link>
                                </motion.div>
                            </motion.div>
                        ...
                        {[
                            {
                                ...
                                description: "AI-powered workout planning that adapts to your availability and recovery needs.",
                            ...
                            },
                            {
                                ...
                                description: "Direct messaging with trainers for personalized guidance and feedback.",
                            ...
                            >
                                <div className="mb-4">
                                    ...
                                    >
                                        <span className={`mdi ${feature.icon} text-xl text-white`}></span>
                                    </div>
                                </div>
                                <h3 className="text-xl font-semibold text-white mb-2">{feature.title}</h3>
                                <p className="text-gray-300 mb-4">{feature.description}</p>
                                <div className="mt-auto">
                                    <Link href={`/features`} className="inline-flex items-center text-sm font-medium">
                                        <span
                                        ...
                                        <span
                                            className={`mdi mdi-arrow-right ml-1 bg-gradient-to-r ${feature.color} bg-clip-text text-transparent group-hover:translate-x-1 transition-transform inline-block`}
                                        ></span>
                                    </Link>
                                </div>
                ...
                >
                    <Link href="/features">
                        <Button variant="orangeFilled" size="large" className="group px-8 py-4">
                            <span className="relative z-10">Explore All Features</span>
                            <span className="mdi mdi-arrow-right ml-2 relative z-10 group-hover:translate-x-1 transition-transform"></span>
                        </Button>
                    </Link>
                </motion.div>
            </div>
