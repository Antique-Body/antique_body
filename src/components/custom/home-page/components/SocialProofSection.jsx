...
export const SocialProofSection = () => {
    ...
    const testimonials = [
        {
            quote: "The ancient-inspired training methods combined with modern tracking have transformed my physique and mindset. I've never felt stronger or more capable.",
            author: "Michael K.",
            role: "Training for 4 months",
            avatar: "https://randomuser.me/api/portraits/men/35.jpg",
            metrics: [
                { label: "Strength", value: "+27%", color: "from-[#FF6B00] to-[#FF9A00]" },
                { label: "Endurance", value: "+42%", color: "from-[#4089FF] to-[#A2C4FF]" },
                { label: "Recovery", value: "+33%", color: "from-[#22c55e] to-[#86efac]" },
            ],
        },
        {
            quote: "As a professional trainer, I've found this platform incredibly valuable. The client matching system has connected me with ideal clients who align with my training philosophy.",
            author: "Sarah J.",
            role: "Certified Trainer",
            avatar: "https://randomuser.me/api/portraits/women/44.jpg",
            metrics: [
                { label: "Clients", value: "+8", color: "from-[#FF6B00] to-[#FF9A00]" },
                { label: "Retention", value: "95%", color: "from-[#4089FF] to-[#A2C4FF]" },
                { label: "Revenue", value: "+40%", color: "from-[#22c55e] to-[#86efac]" },
            ],
        },
        {
            quote: "The combination of ancient techniques with modern analytics has taken my training to another level. The progress tracking features keep me motivated and accountable.",
            author: "David L.",
            role: "Training for 6 months",
            avatar: "https://randomuser.me/api/portraits/men/62.jpg",
            metrics: [
                { label: "Weight", value: "-15kg", color: "from-[#FF6B00] to-[#FF9A00]" },
                { label: "Muscle", value: "+6kg", color: "from-[#4089FF] to-[#A2C4FF]" },
            ...
            <div className="container mx-auto px-4 relative">
                ...
                >
                    ...
                    <p className="text-lg text-gray-300 max-w-2xl mx-auto">
                        Real results from real people. See how our platform has transformed lives and helped users achieve their
                        fitness goals.
                    </p>
                </motion.div>
                                    ...
                                    {testimonials.map((testimonial, index) => (
                                        ...
                                        >
                                            ...
                                            <p className="text-xl md:text-2xl lg:text-3xl leading-relaxed text-gray-100 font-light mb-10">
                                                <span className="relative">
                                                    {testimonial.quote.split(" ").map((word, i) => (
                                                        <span
                                                            key={i}
                                                            className={i % 8 === 0 ? "relative inline-block px-2 mx-1" : ""}
                                                        >
                                                            {i % 8 === 0 && (
                                                                <span className="absolute inset-0 bg-[#FF6B00]/10 rounded-md -skew-x-6"></span>
                                                            )}
                                                            <span
                                                                className={i % 8 === 0 ? "relative text-white font-normal" : ""}
                                                            >
                                                                {word}{" "}
                                                            </span>
                                                        </span>
                                            ...
                                            <div className="flex items-center gap-6">
                                                ...
                                                <div>
                                                    <div className="text-xl font-bold">{testimonial.author}</div>
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center justify-between mb-10">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <div>
                                                    <h3 className="text-lg font-medium text-white">Progress Stats</h3>
                                        ...
                                        <div className="absolute bottom-6 right-6 w-32 h-32">
                                            <svg className="w-full h-full" viewBox="0 0 120 120">
                                                <circle cx="60" cy="60" r="54" fill="none" stroke="#1f1f1f" strokeWidth="12" />
                                                <motion.circle
                                                    cx="60"
                                                    cy="60"
                                                    r="54"
                                                ...
                                                <text x="60" y="75" textAnchor="middle" fill="#9ca3af" fontSize="10">
                                                    Goal Progress
                                                </text>
                                            </svg>
                                        </div>
