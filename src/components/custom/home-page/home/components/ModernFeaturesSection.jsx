        ...
        <div className="w-full">
            ...
            >
                <div className="inline-flex items-center justify-center px-4 py-1.5 rounded-full bg-gradient-to-r from-[#FF6B00]/10 to-transparent backdrop-blur-sm mb-4">
                    <span className="text-sm font-medium text-[#FF6B00]">Revolutionary Approach</span>
                </div>
                ...
                <p className="text-lg text-gray-300 max-w-2xl mx-auto">
                    Our platform merges ancient athletic wisdom with cutting-edge technology to deliver an unparalleled fitness
                    experience
                </p>
            </motion.div>
                        ...
                        >
                            ...
                            <div className="relative w-full h-full">
                                {features[activeFeature].image ? (
                                    ...
                                    <div className="flex items-center justify-center w-full h-full">
                                        <div className="p-8 rounded-full bg-[#FF6B00]/10">
                                            <div className="text-5xl text-[#FF6B00]">{features[activeFeature].icon}</div>
                                        </div>
                                    </div>
                                )}
                                ...
                                <div className="absolute bottom-0 left-0 w-full p-8">
                                    ...
                                    <p className="text-gray-300 max-w-lg">{features[activeFeature].description}</p>
