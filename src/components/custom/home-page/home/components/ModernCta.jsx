            ...
            <div className="relative z-10 px-8 py-20 md:px-16 md:py-24 lg:py-28 lg:px-20">
                <div className="max-w-4xl mx-auto">
                    <div className="text-center">
                        ...
                        >
                            Start your <span className="text-[#FF6B00]">transformation</span> today
                        </motion.h2>
                        ...
                        >
                            Join thousands who have already discovered their ancient strength through our platform. The perfect
                            blend of time-tested methods and modern science.
                        </motion.p>
