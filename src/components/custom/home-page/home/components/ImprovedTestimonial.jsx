    ...
    >
      ...
      <div className="relative z-10 text-center mb-16">
        ...
        <p className="text-gray-300 max-w-2xl mx-auto">
          See how our platform has helped real clients achieve their fitness
          goals with the perfect blend of ancient wisdom and modern science.
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16 items-center">
          <div className="md:col-span-7 relative">
            ...
            <div className="pl-6">
              ...
              >
                The ancient-inspired training methods combined with modern
                tracking have
