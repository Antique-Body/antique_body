    ...
    return (
        <div className="bg-zinc-900/50 backdrop-blur-sm rounded-xl border border-zinc-800 p-4">
            <div className="flex items-center justify-between mb-4">
                ...
                {hasActiveFilters && (
                    <button onClick={onClearFilters} className="text-sm text-[#FF6B00] hover:text-[#FF9A00] transition-colors">
                        Clear all
                    </button>
                )}
            </div>
            ...
            <div className="relative mb-6">
                ...
                {searchQuery && (
                    <button className="absolute inset-y-0 right-0 pr-3 flex items-center" onClick={() => setSearchQuery("")}>
                        <Icon icon="mdi:close" className="h-5 w-5 text-zinc-400 hover:text-white" />
                    </button>
                )}
            </div>
            ...
            <div className="mb-4 border-t border-zinc-800 pt-4">
                ...
                >
                    ...
                    <Icon icon={isExpanded.specialty ? "mdi:chevron-up" : "mdi:chevron-down"} className="h-5 w-5" />
                </button>
            ...
            <div className="mb-4 border-t border-zinc-800 pt-4">
                ...
                >
                    ...
                    <Icon icon={isExpanded.location ? "mdi:chevron-up" : "mdi:chevron-down"} className="h-5 w-5" />
                </button>
            ...
            <div className="mb-4 border-t border-zinc-800 pt-4">
                ...
                >
                    ...
                    <Icon icon={isExpanded.availability ? "mdi:chevron-up" : "mdi:chevron-down"} className="h-5 w-5" />
                </button>
            ...
            <div className="mb-4 border-t border-zinc-800 pt-4">
                ...
                >
                    ...
                    <Icon icon={isExpanded.price ? "mdi:chevron-up" : "mdi:chevron-down"} className="h-5 w-5" />
                </button>
            ...
            <div className="mb-4 border-t border-zinc-800 pt-4">
                ...
                >
                    ...
                    <Icon icon={isExpanded.rating ? "mdi:chevron-up" : "mdi:chevron-down"} className="h-5 w-5" />
                </button>
            ...
            <div className="mb-4 border-t border-zinc-800 pt-4">
                ...
                >
                    ...
                    <Icon icon={isExpanded.tags ? "mdi:chevron-up" : "mdi:chevron-down"} className="h-5 w-5" />
                </button>
