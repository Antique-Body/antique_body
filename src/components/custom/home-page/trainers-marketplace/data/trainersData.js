...
export const trainers = [
    {
        ...
        certifications: ["Certified Strength Coach", "Olympic Weightlifting L3", "Movement Specialist"],
        specializations: ["Olympic Lifting", "Functional Strength", "Athletic Performance"],
        achievements: ["National Weightlifting Champion", "Coached 3 Olympic Athletes"],
    ...
    },
    {
        ...
        certifications: ["Certified Endurance Coach", "HIIT Specialist", "Marathon Training Expert"],
        specializations: ["Long Distance Running", "HIIT Programming", "Cardiovascular Health"],
        ...
        testimonials: [
            {
                ...
                rating: 5,
                comment: "Elena's training program helped me improve my marathon time by over 20 minutes.",
                date: "2023-06-02",
            },
        ],
    ...
    },
    {
        ...
        philosophy: "Combat training builds not just fighters, but disciplined individuals.",
        certifications: ["Certified MMA Coach", "Wrestling Coach Level 3"],
        specializations: ["Traditional Greek Wrestling", "MMA Techniques", "Combat Strength Training"],
        achievements: ["National Wrestling Champion", "Professional MMA Record: 18-2"],
        ...
        testimonials: [
            {
                ...
                rating: 5,
                comment: "Markos's training combines ancient Greek wrestling techniques with modern MMA.",
                date: "2023-05-25",
            },
        ],
        ...
        testimonials: [
            {
                ...
                rating: 4.5,
                comment: "Sophia's flexibility program has completely eliminated my chronic back pain.",
                date: "2023-04-12",
            },
        ],
        ...
        testimonials: [
            {
                ...
                rating: 5,
                comment: "Katerina's functional training program has completely changed how I move.",
                date: "2023-04-28",
            },
        ],
        ...
        testimonials: [
            {
                ...
                rating: 5,
                comment: "Daphne's mobility program has completely transformed my movement patterns.",
                date: "2023-03-15",
            },
        ],
        ...
        testimonials: [
            {
                ...
                rating: 5,
                comment: "Leonidas's Spartan-inspired training methods have given me strength I never thought possible.",
                date: "2023-06-10",
            },
        ],
    ...
    },
    {
        ...
        image: "https://images.pexels.com/photos/4398901/pexels-photo-4398901.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
        isFeatured: true,
        isVerified: true,
...
export const getAllAvailabilityDays = () => {
    const availabilityDays = trainers.flatMap((trainer) => trainer.availability || []);
...
export const extendedTrainers = [
    ...
    },
    {
        ...
        image: "https://images.pexels.com/photos/6551134/pexels-photo-6551134.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
        isFeatured: true,
        isVerified: true,
    ...
    },
    {
        ...
        image: "https://images.pexels.com/photos/1978505/pexels-photo-1978505.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
        isFeatured: true,
        isVerified: true,
    ...
    },
    {
        ...
        image: "https://images.pexels.com/photos/7991663/pexels-photo-7991663.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
        isFeatured: true,
        isVerified: true,
