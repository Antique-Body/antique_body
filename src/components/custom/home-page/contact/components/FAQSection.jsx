  ...
  const faqs = [
    {
      ...
      answer:
        "Our training methods combine ancient Greek athletic wisdom with modern scientific principles, creating a holistic approach to fitness that focuses on both physical and mental development.",
    },
    {
      question: "How do I get started with a trainer?",
      answer:
        "Simply fill out our contact form or call us directly. We'll schedule a consultation to understand your goals and match you with the perfect trainer for your needs.",
    },
    {
      question: "Do you offer online training sessions?",
      answer:
        "Yes, we offer both in-person and online training sessions. Our digital platform allows you to connect with trainers from anywhere in the world.",
    },
    {
      question: "What are your operating hours?",
      answer:
        "Our facility is open Monday through Saturday, from 6 AM to 10 PM. Online training sessions can be scheduled 24/7 based on trainer availability.",
    },
  ];
