            ...
            {tabs.map((tab, index) => (
                <button
                    ...
                    className={`whitespace-nowrap px-4 py-2 text-sm font-medium transition-all duration-300 ${
                        activeTab === tab.id ? "scale-105 transform text-white" : "text-gray-400 hover:text-white"
                    }`}
                ...
                >
                    <span
                        className={`transition-all duration-300 ${activeTab === tab.id ? "translate-y-[-2px] transform" : ""}`}
                    >
                        {tab.label}
                        {tab.badgeCount > 0 && (
                            <span
