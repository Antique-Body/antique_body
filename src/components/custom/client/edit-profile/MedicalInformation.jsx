...
export const MedicalInformation = ({
    ...
    <motion.div className="space-y-6 border-t border-[#333] pt-8" variants={staggerItems} initial="hidden" animate="visible">
        ...
        <motion.div variants={fadeInUp}>
            <div className="mt-6 rounded-lg border border-[#2a2a2a] bg-[#1a1a1a]/50 p-4">
                ...
                <p className="text-sm text-gray-300">
                    Providing accurate medical information helps your trainers create safer workout plans tailored to your
                    needs. Always consult with a healthcare professional before starting any new fitness program, especially if
