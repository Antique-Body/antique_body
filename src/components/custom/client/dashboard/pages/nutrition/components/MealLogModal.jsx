...
const FoodCard = ({ food, onAdd }) => (
  ...
  >
    ...
    <button 
      className="mt-2 w-full text-xs py-1 px-2 bg-[rgba(255,107,0,0.1)] text-[#FF6B00] rounded hover:bg-[rgba(255,107,0,0.2)] transition-colors"
    >
      Add to Meal
    </button>
  </div>
