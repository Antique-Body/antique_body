...
import { ClientIcon, GreekPatternBorder, TrainerIcon, UserIcon, SoloIcon } from "@/components/common/Icons";
    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col items-center relative z-10">
                ...
                <p className={`mt-3 text-sm text-center max-w-xs ${isSelected ? "text-white" : "text-gray-300"}`}>
                    {description}
                </p>
                <span
            ...
            {isSelected && <div className="absolute inset-0 rounded-xl bg-orange-500 opacity-20 blur-xl -z-10"></div>}
