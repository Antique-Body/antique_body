...
export const AboutYou = ({ trainerData, handleChange, newEducation, setNewEducation, addEducation, removeEducation }) => (
    <motion.div variants={staggerItems} initial="hidden" animate="visible" className="space-y-6 border-t border-[#333] pt-8">
        ...
        <motion.div variants={fadeInUp}>
            ...
            <p className="mt-2 text-xs text-gray-400">Example: "Bachelor's in Exercise Science, University of California"</p>
        </motion.div>
    </motion.div>
);
