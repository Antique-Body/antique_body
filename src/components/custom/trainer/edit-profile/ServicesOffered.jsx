...
import { PlusIcon, SettingsIcon, TrashIcon } from "@/components/common/Icons";
...
export const ServicesOffered = ({ trainerData, newService, setNewService, addService, removeService }) => (
    <motion.div variants={staggerItems} initial="hidden" animate="visible" className="space-y-6 border-t border-[#333] pt-8">
                ...
                >
                    ...
                    <div className="mb-3 flex items-center">
                        <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[rgba(255,120,0,0.15)]">
                            <SettingsIcon size={20} className="text-[#FF7800]" />
                        </div>
        ...
        <motion.div variants={fadeInUp} className="overflow-hidden rounded-xl bg-[rgba(30,30,30,0.6)] p-0.5 backdrop-blur-md">
                ...
                <div className="grid grid-cols-1 gap-4">
                    ...
                    <div className="flex flex-col space-y-3">
                        <Button
                            ...
                            leftIcon={
                                <PlusIcon size={16} className="transition-transform duration-300 group-hover:rotate-90" />
                            }
                        >
                            Add Service
                        </Button>
