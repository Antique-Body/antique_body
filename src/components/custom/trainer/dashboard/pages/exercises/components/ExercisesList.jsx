...
export const ExercisesList = ({ exercises, onUpdate }) => {
    ...
    const filteredExercises = exercises.filter((exercise) => {
        ...
        const matchesEquipment =
            filterEquipment === "with" ? exercise.equipment : filterEquipment === "without" ? !exercise.equipment : true;
    ...
    const handleSaveExercise = (updatedExercise) => {
        ...
        if (modalMode === "create") {
            ...
            newExercises = exercises.map((ex) => (ex.id === updatedExercise.id ? updatedExercise : ex));
        }
