  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-75 backdrop-blur-sm">
      <div className="animate-fade-in relative w-full max-w-2xl overflow-hidden rounded-xl border border-[#333] bg-[#121212]">
        ...
        <div className="p-6">
          <h2 className="mb-1 text-xl font-bold">Message {client?.name}</h2>
          <p className="mb-4 text-gray-400">Send a message or update about training, nutrition, or progress</p>
            ...
            <div className="mb-5">
              ...
              <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
                ...
                <Button
                  ...
                  variant="secondary"
                  onClick={() =>
                    setMessage("I've updated your training program for next week. Take a look when you have a chance.")
                  }
                  className="text-left text-sm"
                >
                  Program Update
