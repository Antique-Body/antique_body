...
export const PerformanceMetrics = ({ clientType, clientGoal, progress = [], onMetricAdd }) => {
  ...
  return (
    <div className="space-y-4">
      ...
      {progress.length < 2 ? (
        <p className="text-sm text-gray-400">Add at least two entries to see progress metrics</p>
      ) : (
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
          {sortedMetrics.map(metric => {
            ...
            return (
              <div key={metric.id} className="rounded-lg border border-[#333] bg-[rgba(30,30,30,0.8)] p-4">
      ...
      {onMetricAdd && (
        <div className="mt-4">
          <h4 className="mb-2 text-sm font-medium text-gray-300">Track Additional Metrics</h4>
