                ...
                <div className="p-4">
                  <div className="mb-4">
                    ...
                    <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
                      {mockPlans.find(p => p.id === selectedPlanId)?.days.map((day) => (
                        <div key={day.day} className="rounded-md border border-[#444] bg-[rgba(20,20,20,0.3)] p-3 hover:border-[#FF6B00]/50 transition-colors duration-200">
                          ...
                          <div className="mt-2">
                            {day.exercises.slice(0, 3).map((ex, idx) => (
                              <div key={idx} className="text-xs text-gray-400">• {ex.name}</div>
                            ))}
                            {day.exercises.length > 3 && (
                              <div className="text-xs text-gray-500">+ {day.exercises.length - 3} more</div>
                            )}
                          </div>
                        </div>
                      ))}
                    ...
                    <div className="rounded-md border border-[#444] bg-[rgba(20,20,20,0.3)] p-3">
                      <div className="mb-2 grid grid-cols-2 gap-2 sm:grid-cols-4">
                        <div className="rounded-md bg-[rgba(30,30,30,0.6)] p-2 text-center">
                          ...
                          <div className="text-sm font-medium text-white">{mockPlans.find(p => p.id === selectedPlanId)?.nutrition.dailyCalories}</div>
                        </div>
                        <div className="rounded-md bg-[rgba(30,30,30,0.6)] p-2 text-center">
                          <div className="text-xs text-gray-400">Protein</div>
                          <div className="text-sm font-medium text-white">{mockPlans.find(p => p.id === selectedPlanId)?.nutrition.macros.protein}</div>
                        </div>
                        <div className="rounded-md bg-[rgba(30,30,30,0.6)] p-2 text-center">
                          <div className="text-xs text-gray-400">Carbs</div>
                          <div className="text-sm font-medium text-white">{mockPlans.find(p => p.id === selectedPlanId)?.nutrition.macros.carbs}</div>
                        </div>
                        <div className="rounded-md bg-[rgba(30,30,30,0.6)] p-2 text-center">
                          <div className="text-xs text-gray-400">Fats</div>
                          <div className="text-sm font-medium text-white">{mockPlans.find(p => p.id === selectedPlanId)?.nutrition.macros.fats}</div>
                        </div>
                      </div>
        ...
        {mode === "custom" && (
          <div>
            ...
            {customPlan.days.map((day, dayIndex) => (
              <div key={dayIndex} className="mb-5 rounded-lg border border-[#333] bg-[rgba(30,30,30,0.6)] p-4 hover:border-[#FF6B00]/30 transition-colors duration-200">
                      ...
                      <div className="mb-2 flex items-center justify-between">
                        <div className="flex items-center">
                          <div className="flex h-5 w-5 items-center justify-center rounded-full bg-[rgba(255,255,255,0.1)] mr-2">
                            <span className="text-xs font-medium text-white">{exerciseIndex + 1}</span>
                          </div>
