...
import { CheckIcon, PlusIcon, StrengthIcon, TrashIcon } from "@/components/common/Icons";
import { Card } from "@/components/custom/Card";
import mockExercises from "@/components/custom/trainer/dashboard/pages/exercises/data/mockExercises";

export const PlanDaysStep = ({ initialData = [], onSubmit }) => {
    ...
    return (
        <div className="p-6">
            ...
            <p className="mb-8 text-gray-400">
                Create your training plan by adding exercises for each day. Set the number of sets, reps, and rest periods for
                each exercise.
            </p>
            ...
            <form onSubmit={handleSubmit}>
                <div className="space-y-8">
                    ...
                    <div className="flex justify-center">
                        <Button variant="orangeOutline" onClick={addDay} className="px-6" leftIcon={<PlusIcon size={16} />}>
                            Add Training Day
                        </Button>
                    </div>

                    <div className="pt-6">
                        <Button type="submit" variant="orangeFilled" className="w-full py-3" leftIcon={<CheckIcon size={16} />}>
