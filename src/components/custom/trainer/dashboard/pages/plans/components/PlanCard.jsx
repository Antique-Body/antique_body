...
import { ClockIcon, CopyIcon, DollarIcon, EditIcon, TrashIcon, UsersIcon } from "@/components/common/Icons";
...
export const PlanCard = ({
    ...
    const handleCopyClick = () => {
        ...
        router.push(`${editUrl}?mode=copy&title=${encodeURIComponent(`Copy of ${title}`)}`);
    };
    ...
    return (
        <>
                        ...
                        <div className="mt-auto space-y-4">
                            ...
                            <div className="flex items-center justify-between" onClick={(e) => e.stopPropagation()}>
                                <div className="flex space-x-2">
                                    ...
                                    <Button variant="dangerOutline" size="small" leftIcon={<TrashIcon size={16} />}>
                                        Delete
                                    </Button>
                                </div>
                                <Button
            ...
            {/* Preview Modal */}
            <PlanPreviewModal plan={planData} isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} />
        </>
    );
};
