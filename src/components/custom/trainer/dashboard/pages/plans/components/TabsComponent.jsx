...
export const TabsComponent = ({ activeTab, setActiveTab }) => {
    const tabs = [
        ...
        },
        {
            ...
            description: "Create and manage meal plans, recipes, macro targets and nutritional guidelines for your clients.",
                    ...
                    {tabs.map((tab) => (
                        <button
                            ...
                            className={`
                                ...
                                ${activeTab === tab.id ? "text-white z-10" : "text-gray-400 hover:text-gray-200"}
                            `}
                        >
                            {activeTab === tab.id && (
                                <motion.div
                            ...
                            <div
                                className={`relative transition-all duration-300 ${activeTab === tab.id ? "scale-110" : "scale-100"}`}
                            >
                                <motion.div
                                    animate={
                                        activeTab === tab.id
                            ...
                            >
                                ...
                                <span className="xs:hidden">{tab.id === "nutrition" ? "Nutrition" : "Training"}</span>
                            </motion.span>
                        </button>
                    ))}
                </div>
