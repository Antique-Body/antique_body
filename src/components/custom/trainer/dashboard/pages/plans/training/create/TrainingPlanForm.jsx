...
const STEPS = [
    { id: "info", label: "Plan Information" },
...
export const TrainingPlanForm = () => {
    ...
    const [planData, setPlanData] = useState({
        ...
        durationType: "weeks",
        duration: "4",
        trainingType: "with-trainer", // with-trainer, self-guided, hybrid
        sessionsPerWeek: "3",
        sessionFormat: {
            inPerson: true,
            online: false,
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <div className="mb-6 flex items-center">
                ...
                <h1 className="ml-4 text-2xl font-bold text-white">Create Training Plan</h1>
            </div>
            ...
            <Card variant="darkStrong" width="100%" maxWidth="100%" className="mb-6">
                <div className="flex justify-between border-b border-[#333] pb-4 mb-6">
                    <div className="flex items-center">
                        ...
                        <h2 className="text-lg font-semibold text-white">{STEPS[currentStep].label}</h2>
                    </div>
