...
export const ScheduleSessionModal = ({ client, onClose, onSchedule, isOpen }) => {
    ...
    return (
        <Modal
            isOpen={isOpen}
            onClose={onClose}
            title={`Schedule Session with ${client?.name}`}
            message="Pick a date and time that works for both of you"
            primaryButtonText="Schedule Session"
            primaryButtonAction={handleSubmit}
            primaryButtonDisabled={!date || !time}
